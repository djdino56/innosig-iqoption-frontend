...
export default {
  ...
  data() {
    return {
      ...
      selected: null,
      createColumns: ['name', 'indicators', 'interval', 'minimal_buy_signals', 'minimal_sell_signals', 'enabled'],
      updateColumns: ['name', 'indicators', 'interval', 'minimal_buy_signals', 'minimal_sell_signals', 'enabled'],
    };
  },
  watch: {
