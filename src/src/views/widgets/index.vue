...
<template>
  <Layout>
    ...
    <b-row>
      <b-col xl="3" md="6">
        <b-card no-body class="bg-primary card-height-100">
          <b-card-body>
            <div class="d-flex align-items-center">
              <div class="avatar-sm flex-shrink-0">
    ...
    <b-row>
      <b-col xl="4">
        <b-card no-body>
          <b-card-body class="p-0">
            <b-alert variant="primary" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
            ...
            <b-row class="align-items-end">
              <b-col sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <router-link to="/pages/profile" class="btn btn-primary">Upgrade 
                      Account!</router-link>
                  </div>
                </div>
              </b-col>
        ...
        <b-card no-body class="bg-primary">
          <b-card-body class="p-0">
            ...
            <b-row class="align-items-end">
              <b-col sm="8">
                <div class="p-3">
                  <p class="fs-16 lh-base text-white">Upgrade your plan from a
          ...
          <b-card-body class="p-0">
            ...
            <div class="d-flex p-3">
              ...
              <div>
                ...
                <div class="mt-3">
                  <router-link to="/pages/profile" class="btn btn-secondary">Get a Free 
                    Gift</router-link>
                </div>
              </div>
            </div>
      ...
      <b-col xxl="4">
        <b-card no-body class="card-height-100">
          ...
          <b-card-header class="p-0">
            <b-alert variant=""
              class="alert-primary alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center"
              role="alert">
              <i class="ri-error-warning-line label-icon"></i>
              <div class="flex-grow-1 text-truncate">
                Your free trial expired in <b>17</b> days.
        ...
        <b-card no-body class="card-height-100">
          <b-card-header class="align-items-center d-flex">
            <b-card-title class="mb-0 flex-grow-1">
              Top Referrals Pages</b-card-title>
            <div class="flex-shrink-0">
              <b-button variant="soft-primary" size="sm">
                Export Report
              </b-button>
              ...
              <b-col xl="6">
                ...
                <ul class="clothes-size list-unstyled hstack gap-2 mb-0">
                  <li>
                    ...
                    <label class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                      for="color-1">S</label>
                  </li>
                  <li>
