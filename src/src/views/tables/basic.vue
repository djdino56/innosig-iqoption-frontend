                                ...
                                <table class="table table-striped table-nowrap align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Nov 14, 2021</td>
                                            <td>$2,410</td>
                                            <td><b-badge variant="soft-success" class="badge-soft-success">Confirmed</b-badge></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>Nov 21, 2021</td>
                                            <td>$1,450</td>
                                            <td><b-badge variant="soft-warning" class="badge-soft-warning">Waiting</b-badge></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>Nov 25, 2021</td>
                                            <td>$6,875</td>
                                            <td><b-badge variant="soft-danger" class="badge-soft-danger">Cancelled</b-badge></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>07 Oct, 2021</td>
                                            <td>$24.05</td>
                                            <td><b-badge class="badge-soft-success" variant="soft-success">Paid</b-badge></td>
                                            <td>
                                                <b-button type="button" variant="light" size="sm">Details</b-button>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>06 Oct, 2021</td>
                                            <td>$21.25</td>
                                            <td><b-badge variant="soft-danger" class="badge-soft-danger">Refund</b-badge></td>
                                            <td>
                                                <b-button type="button" variant="light" size="sm">Details</b-button>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="hstack gap-3 fs-15">
                                                    ...
                                                    <b-link href="javascript:void(0);" class="link-success"><i
                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>$860</td>
                                            <td>
                                                <b-progress class="progress-sm" :value="65" variant="primary" />
                                            </td>
                                            <td>
                                                <b-link href="javascript:void(0);" class="link-primary">Waiting</b-link>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Leslie Alexander</td>
                                            ...
                                            <td>$450</td>
                                            <td>
                                                <b-progress class="progress-sm" :value="35" variant="primary" />
                                            </td>
                                            <td>
                                                <b-link href="javascript:void(0);" class="link-primary">Waiting</b-link>
                                            </td>
