            ...
            <div class="d-md-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex gap-1 flex-wrap">
                  ...
                  <b-button type="button" variant="success"><i
          ...
          <b-card-body class="border border-dashed border-end-0 border-start-0">
            <b-form>
              <b-row class="g-3">
                ...
                <b-col xxl="1" sm="4">
                  <div>
                    <b-button type="button" variant="info" @click="SearchData" class="w-100"> <i
              ...
              <div class="table-responsive table-card mb-1">
                ...
                <div class="noresult" style="display: none" :class="{ 'd-block': resultQuery.length == 0 }">
                  <div class="text-center">
                    <lottie class="avatar-xl" colors="primary:#25a0e2,secondary:#25a0e2" :options="defaultOptions"
                      :height="75" :width="75" />
