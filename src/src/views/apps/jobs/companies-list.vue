          ...
          <b-card-body>
            <b-form>
              <b-row class="g-3">
                ...
                <b-col xxl="2" sm="4">
                  <b-button type="button" variant="primary" class="w-100" onclick="filterData();">
        ...
        <b-card no-body id="company-overview">
          ...
          <b-card-body>
            ...
            <div class="hstack gap-3">
              ...
              <b-link href="#!" class="btn btn-info w-100">More View <i class="ri-arrow-right-line align-bottom"></i>
              </b-link>
            </div>
          </b-card-body>
        </b-card>
