...
<template>
  <Layout>
            ...
            <b-row class="g-4 align-items-center">
              ...
              <b-col sm="auto" class="ms-auto">
                <div class="hstack gap-2">
                  ...
                  <b-button type="button" variant="soft-success" class="add-btn" id="create-btn" @click="addnew">
                  ...
                  <span class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                      ...
                      <li>
                        <b-link class="dropdown-item" href="#">Switch to common form
                          view</b-link>
                      </li>
                      <li>
                        <b-link class="dropdown-item" href="#">Reset form view to
                          default</b-link>
                      </li>
                    </ul>
                  </span>
              ...
              <div class="table-responsive table-card">
                ...
                <div class="noresult" style="display: none">
                  <div class="text-center">
                    <lottie class="avatar-xl" colors="primary:#25a0e2,secondary:#00bd9d" :options="defaultOptions" :height="75" :width="75" />
    ...
    <b-modal v-model="addLeadsModal" id="showmodal" hide-footer title-class="exampleModalLabel" header-class="p-3 bg-soft-info " class="v-modal-custom" centered size="lg">
      <b-form action="" id="addform" class="tablelist-form" autocomplete="off">
        ...
        <b-row class="g-3">
          ...
          <div>
            ...
            <Multiselect v-model="tagvalue" mode="tags" :close-on-select="true" :searchable="true" :create-option="false" :options="tagoption" />
          </div>
          <b-col lg="12">
            <div>
              <label for="date-field" class="form-label">Created
                Date</label>
              <flat-pickr placeholder="Select date" v-model="date2" :config="timeConfig" class="form-control flatpickr-input" id="date"></flat-pickr>
            </div>
          </b-col>
        </b-row>
