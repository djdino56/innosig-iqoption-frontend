                        ...
                        <div class="d-flex hastck gap-2 flex-wrap">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li><b-link class="dropdown-item" href="#">Switch to common form view</b-link>
                                    </li>
                                    <li> <b-link class="dropdown-item" href="#">Reset form view to default</b-link>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <b-row class="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
            <b-col>
                <b-card no-body class="border-0 overflow-hidden">
                    <b-link class="card-header bg-soft-primary" role="button" v-b-toggle.leadDiscovered>
                ...
                <b-collapse id="leadDiscovered" visible>
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="leadDiscovered1">
                            <b-card-body>
                                <h6 class="fs-14 mb-1">Nesta Technologies <b-badge tag="small" variant="soft-danger" class="badge-soft-primary">4
                                        Days</b-badge></h6>
            ...
            <b-col>
                <b-card no-body>
                    <b-link class="card-header bg-soft-primary" role="button" v-b-toggle.contactInitiated>
            ...
            <b-col>
                <b-card no-body>
                    <b-link class="card-header bg-soft-primary" role="button" v-b-toggle.needsIdentified>
            ...
            <b-col>
                <b-card no-body>
                    <b-link class="card-header bg-soft-primary" role="button" v-b-toggle.meetingArranged>
            ...
            <b-col>
                <b-card no-body>
                    <b-link class="card-header bg-soft-primary" role="button" v-b-toggle.offerAccepted>
                    ...
                    <b-card no-body class="mb-1">
                        ...
                        <b-collapse class="border-top border-top-dashed" id="offerAccepted4">
                            ...
                            <b-card-footer class="hstack gap-2">
                                <b-button variant="warning" size="sm" class="w-100"><i
                                        class="ri-phone-line align-bottom me-1"></i> Call</b-button>
                                <b-button variant="info" size="sm" class="w-100"><i class="ri-question-answer-line align-bottom me-1"></i> 
                                        Message</b-button>
                            </b-card-footer>
                        </b-collapse>
                    </b-card>
