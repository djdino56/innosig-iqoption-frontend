...
<template>
  <Layout>
            ...
            <div class="d-flex align-items-center flex-wrap gap-2">
              ...
              <div class="flex-shrink-0">
                <div class="hstack text-nowrap gap-2">
                  ...
                  <b-button variant="soft-primary" class="soft-primary">
                    <i class="ri-filter-2-line me-1 align-bottom"></i> Filters
                  </b-button>
                  <b-button variant="soft-success">Import</b-button>
                  <b-button type="button" variant="soft-danger" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <table class="table align-middle table-nowrap mb-0" id="customerTable">
                  ...
                  <tbody class="list form-check-all">
                    <tr v-for="(data, index) of resultQuery" :key="index">
                      ...
                      <td class="id" style="display: none"> <b-link href="javascript:void(0);" class="fw-medium link-primary">{{ data._id }}</b-link>
                      </td>
                      <td>
    ...
    <b-modal v-model="addCompanyModal" id="showmodal" hide-footer title-class="exampleModalLabel"
      header-class="p-3 bg-soft-primary" class="v-modal-custom" centered size="lg" title="Add Task">
      <b-form id="addform" class="tablelist-form" autocomplete="off">
        ...
        <div class="hstack gap-2 justify-content-end mt-3">
          ...
          <b-button type="button" variant="primary" id="add-btn" @click="addorder">Add Company</b-button>
