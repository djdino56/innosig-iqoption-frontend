        ...
        <b-card no-body id="contact-view-detail">
          <b-card-body class="text-center">
            ...
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item avatar-xs">
                <b-link href="javascript:void(0);" class="avatar-title bg-soft-primary text-primary fs-15 rounded">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td id="tags" class="hstack gap-1">
                      <b-badge variant="soft-secondary" class="badge-soft-secondary">Lead</b-badge>
                      <b-badge variant="soft-secondary" class="badge-soft-secondary">Partner</b-badge>
                    </td>
                  </tr>
                  <tr>
    ...
    <b-modal v-model="addContactModal" id="showmodal" hide-footer title-class="exampleModalLabel"
      ...
      <b-form action="" id="addform" class="tablelist-form" autocomplete="off">
        ...
        <div class="hstack gap-2 justify-content-end mt-3">
          ...
          <b-button type="button" variant="primary" id="add-btn" @click="addorder">Add Contact</b-button>
