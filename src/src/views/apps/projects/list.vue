  ...
  <Layout>
    ...
    <b-modal v-model="removeProjectModal" id="removeProjectModal" hide-footer class="v-modal-custom"
      ...
      <div class="mt-2 text-center">
        <lottie class="avatar-xl" colors="primary:#25a0e2,secondary:#00bd9d" :options="defaultOptions" :height="100"
          :width="100" />
      ...
      <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
        ...
        <b-button type="button" variant="primary" class="w-sm" id="remove-project">Yes, Delete It!</b-button>
      </div>
    </b-modal>
