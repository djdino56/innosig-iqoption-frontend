                                        ...
                                        <b-col md>
                                            <div>
                                                ...
                                                <div class="hstack gap-3 flex-wrap">
                                                    ...
                                                    <b-badge variant="success" pill class="bg-success fs-12">High</b-badge>
                                                </div>
                                            </div>
                                        </b-col>
                                    </b-row>
                ...
                <div class="tab-content text-muted">
                                ...
                                <b-card no-body>
                                    <b-card-body>
                                        <div class="text-muted">
                                            ...
                                            <div>
                                                <b-button type="button" variant="link" class="link-secondary p-0">Read
                                                    more</b-button>
                                            </div>
                                                ...
                                                <b-row>
                                                    ...
                                                    <b-col lg="3" sm="6">
                                                        <div>
                                                            ...
                                                            <b-badge tag="div" class="bg-success fs-12">High</b-badge>
                                                        </div>
                                                    </b-col>
                                                    <b-col lg="3" sm="6">
                                                        <div>
                                                            <p class="mb-2 text-uppercase fw-medium">Status :</p>
                                                            <b-badge tag="div" variant="primary" class="bg-primary fs-12">Inprogess</b-badge>
                                                        </div>
                                                    </b-col>
                                                </b-row>
                                            </div>
                            ...
                            <b-col xl="3" lg="4">
                                ...
                                <b-card no-body>
                                    <b-card-header class="align-items-center d-flex border-bottom-dashed">
                                        ...
                                        <div class="flex-shrink-0">
                                            <b-button type="button" variant="soft-primary" size="sm"><i
                    ...
                    <div class="tab-pane fade" id="project-team" role="tabpanel">
                        <b-row class="g-4 mb-3">
                            ...
                            <b-col sm="auto">
                                <div>
                                    <b-button type="button" variant="primary"><i
