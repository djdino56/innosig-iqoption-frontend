    ...
    <Layout>
        ...
        <div class="tasks-board mb-3" id="kanbanboard">
                                    ...
                                    <div class="d-flex mb-2">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <li>
                                                    <router-link class="dropdown-item" to="/apps/tasks-details"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> 
                                                    View </router-link> </li>
                                                <li>
                                                    <b-link class="dropdown-item" href="#"><i class="ri-edit-2-line align-bottom me-2 text-muted"></i>
                                                    Edit</b-link> </li>
                                                <li>
                                                    <b-link class="dropdown-item" @click="deleteTask"><i class="ri-delete-bin-5-line align-bottom me-2 text-muted"></i>
                                                    Delete</b-link> </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <ul class="link-inline mb-0">
                                                ...
                                                <li class="list-inline-item">
                                                    <b-link href="javascript:void(0)" class="text-muted"><i class="ri-question-answer-line align-bottom"></i> 
                                                    19</b-link>
                                                </li>
                                                <li class="list-inline-item">
                                                    <b-link href="javascript:void(0)" class="text-muted"><i
            ...
            <div class="tasks-list">
                ...
                <div class="my-3">
                    <b-button variant="primary" class="w-100" @click="modalShow2 = !modalShow2">Add More</b-button>
                </div>
            </div>
            <div class="tasks-list">
                <div class="d-flex mb-3">
                    <div class="flex-grow-1">
                        <h6 class="fs-14 text-uppercase fw-semibold mb-0">Inprogress 
                            <b-badge tag="small" class="bg-primary align-bottom ms-1">2</b-badge>
                        </h6>
                    </div>
                    <div class="flex-shrink-0">
                        <div class="dropdown card-header-dropdown">
                            ...
                            <b-card no-body class="tasks-box" v-for="(data, index) of completed" :key="index">
                                <b-card-body>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="progress rounded-3 progress-sm">
                                            <div class="progress-bar bg-pr" role="progressbar" style="width: 15%"
                                                aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
        ...
        <b-modal v-model="modalShow" header-class="p-3 bg-soft-primary" content-class="border-0" hide-footer
            ...
            <div class="modal-footer v-modal-footer">
                ...
                <b-button type="button" variant="primary" id="addMember">Add Member</b-button>
            </div>
        </b-modal>

        <b-modal v-model="modalShow1" header-class="p-3 bg-soft-primary" content-class="border-0" hide-footer
                ...
                <b-row>
                    ...
                    <div class="mt-4">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <b-button type="button" variant="primary" id="addNewBoard">Add 
                                Board</b-button>
                        </div>
                    </div>
                </b-row>
        ...
        <b-modal v-model="modalShow2" header-class="p-3 bg-soft-primary" content-class="border-0" hide-footer
                ...
                <b-row class="g-3">
                    ...
                    <div class="mt-4">
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <b-button type="button" variant="primary" @click="addNewTask">Add Task</b-button>
                        </div>
                    </div>
                </b-row>
            </b-form>
        ...
        <b-modal v-model="modalShow3" id="deleteTask" modal-class="zoomIn" hide-footer class="v-modal-custom" centered>
            ...
            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                ...
                <b-button type="button" variant="danger" class="w-sm" id="delete-record">Yes, Delete 
                    It!</b-button>
            </div>
        </b-modal>
