...
<template>
    <Layout>
            ...
            <b-col xxl="3">
                <b-card no-body>
                    <b-card-body class="text-center">
                        ...
                        <div class="mb-2">
                            <lottie colors="primary:#25a0e2,secondary:#00bd9d" :options="defaultOptions" :height="90"
                                :width="90" />
                        </div>
                        <h3 class="mb-1">9 hrs 13 min</h3>
                        <h5 class="fs-14 mb-4">Profile Page Satructure</h5>
                        <div class="hstack gap-2 justify-content-center">
                            <b-button variant="primary" size="sm"><i class="ri-stop-circle-line align-bottom me-1"></i>
                                Stop</b-button>
                            <b-button variant="soft-secondary" size="sm"><i class="ri-play-circle-line align-bottom me-1"></i>
                                Start</b-button>
                        </div>
                    </b-card-body>
                </b-card>
                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><b-badge variant="soft-primary" class="badge-soft-primary">High</b-badge></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-medium">Status</td>
                                        <td><b-badge variant="soft-success" class="badge-soft-success">Inprogress</b-badge></td>
                                    </tr>
                                    <tr>
                    ...
                    <b-card-body>
                        <div class="d-flex mb-3">
                            ...
                            <div class="flex-shrink-0">
                                <b-button type="button" variant="soft-primary" size="sm" @click="modalShow = !modalShow">
                        ...
                        <div class="text-muted">
                            ...
                            <div class="pt-3 border-top border-top-dashed mt-4">
                                ...
                                <div class="hstack flex-wrap gap-2 fs-15">
                                    ...
                                    <b-badge variant="soft-secondary" tag="div" class="fw-medium badge-soft-secondary">Dashboard</b-badge>
                                    <b-badge variant="soft-secondary" tag="div" class="fw-medium badge-soft-secondary">Design</b-badge>
                                </div>
                            </div>
                        </div>
                    </b-card-body>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            <h6 class="fs-15 mb-0">
                                                                <b-link href="javascript:void(0)" class="link-secondary">App
                                                                    pages.zip</b-link>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            <h6 class="fs-15 mb-0">
                                                                <b-link href="javascript:void(0);" class="link-secondary">Velzon
                                                                    admin.ppt</b-link>
                                                            </h6>
                                                        </div>
                                                    </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            <h6 class="fs-15 mb-0">
                                                                <b-link href="javascript:void(0);" class="link-secondary">Images.zip</b-link>
                                                            </h6>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-3 flex-grow-1">
                                                            <h6 class="fs-15 mb-0">
                                                                <b-link href="javascript:void(0);" class="link-secondary">Bg-pattern.png
                                                                </b-link>
                                                            </h6>
                                                        </div>
                                                    </div>
        ...
        <b-modal v-model="modalShow" hide-footer title="Team Members" body-class="p-4" content-class="border-0"
            header-class="p-3 ps-4 bg-soft-primary" class="v-modal-custom" centered>
            ...
            <div class="modal-footer v-modal-footer">
                <b-button type="button" variant="light" class="w-xs" @click="modalShow = false">
                    Cancel</b-button>
                <b-button type="button" variant="primary" class="w-xs">Assigned</b-button>
            </div>
        </b-modal>
    </Layout>
</template>