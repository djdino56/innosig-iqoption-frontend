...
<template>
  <Layout>
        ...
        <b-card no-body class="card-animate">
          <b-card-body>
            <div class="d-flex justify-content-between">
              ...
              <div>
                <div class="avatar-sm flex-shrink-0">
                  <span class="avatar-title bg-soft-primary text-success rounded-circle fs-4">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex flex-wrap gap-2">
                  ...
                  <b-button variant="soft-primary" class="add-btn" @click="addnew">
    ...
    task.status
              ...
              <div class="noresult" style="display: none">
                <div class="text-center">
                  <lottie colors="primary:#25a0e2,secondary:#00bd9d" :options="defaultOptions" :height="75"
                    :width="75" />
    ...
    <b-modal v-model="taskListModal" id="showmodal" modal-class="zoomIn" hide-footer
      header-class="p-3 bg-soft-primary taskModal" class="v-modal-custom" centered size="lg" title="Add Task">
