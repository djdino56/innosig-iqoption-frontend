        ...
        <b-card no-body id="invoiceList">
          ...
          <b-card-body>
            ...
            <b-modal v-model="invoiceListModal" id="deleteOrder" modal-class="flip" hide-footer
              header-class="p-3 bg-light" class="v-modal-custsom" centered no-close-on-backdrop>
              <lottie class="avatar-xl" colors="primary:#25a0e2,secondary:#00bd9d" :options="defaultOptions1" :height="90" :width="90" />
              <div class="mt-4 text-center">
                ...
                <div class="hstack gap-2 justify-content-center remove">
                  <b-button variant="primary" class="btn-link fw-medium text-decoration-none"><i class="ri-close-line me-1 align-middle"></i> Close</b-button>
                  <b-button class="btn btn-primary" id="delete-record">Yes, Delete It</b-button>
                </div>
              </div>
            </b-modal>
