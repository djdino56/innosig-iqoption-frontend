                ...
                <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3 active" id="pills-bill-info-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="true">
                      <i class="ri-user-2-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-soft-primary text-primary rounded-circle align-middle me-2"></i>
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3" id="pills-bill-address-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <i class="ri-truck-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-soft-primary text-primary rounded-circle align-middle me-2 "></i>
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3" id="pills-payment-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <i class="ri-bank-card-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-soft-primary text-primary rounded-circle align-middle me-2"></i>
                      Payment Info </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link fs-15 p-3" id="pills-finish-tab" data-bs-toggle="pill"
                      ...
                      aria-selected="false">
                      <i class=" ri-checkbox-circle-line fs-16 avatar-xs d-inline-flex align-items-center justify-content-center bg-soft-primary text-primary rounded-circle align-middle me-2"></i> Finish </button>
                  </li>
                </ul>
              </div>
                  ...
                  <div>
                    ...
                    <div class="d-flex align-items-start gap-3 mt-3">
                      <b-button variant="primary" type="button" class="btn-label right ms-auto nexttab"
                        data-nexttab="pills-bill-address-tab"> <i class="ri-truck-line label-icon align-middle fs-16 ms-2"></i>Proceed
                ...
                <div class="tab-pane fade" id="pills-bill-address" role="tabpanel"
                  ...
                  <div class="mt-4">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <div class="flex-shrink-0">
                        <b-button type="button" variant="primary" size="sm" class="mb-3">
                          Add Address
                        </b-button>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-start gap-3 mt-4">
                    <b-button type="button" variant="light" class="btn-label previestab"
                      ...
                      to Personal Info</b-button>
                    <b-button type="button" variant="primary" class="btn-label right ms-auto nexttab" data-nexttab="pills-payment-tab">
              ...
              <table class="table table-borderless align-middle mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <h5 class="fs-14">
                        <router-link to="/ecommerce/product-details" class="text-dark">350 ml Glass Grocery Container </router-link>
                      </h5>
