              ...
              <div>
                ...
                <div class="mt-3">
                  ...
                  <b-row class="align-items-center g-2">
                    ...
                    <b-col>
                      <div class="p-1">
                        <b-progress variant="secondary" class="animated-progess progress-sm" :value="4.98" />
                      </div>
                    </b-col>
                    ...
                    <b-card-body>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div>
                            <p class="text-muted mb-1 fst-italic text-truncate-two-lines"> " Great
                  ...
                  <b-card no-body class="border border-dashed shadow-none">
                    <b-card-body>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div>
                            <p class="text-muted mb-1 fst-italic text-truncate-two-lines">" Amazing
                  ...
                  <b-card no-body class="border border-dashed shadow-none">
                    <b-card-body>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div>
                            <p class="text-muted mb-1 fst-italic text-truncate-two-lines"> "Very
                  ...
                  <b-card no-body class="border border-dashed shadow-none">
                    <b-card-body>
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <div>
                            <p class="text-muted mb-1 fst-italic text-truncate-two-lines"> "The product
            ...
            <b-row class="g-0 text-center">
              <b-col cols="6" sm="3">
                <div class="p-3 border border-dashed border-start-0">
                  <h5 class="mb-1"><count-to :duration="5000" :startVal="0" :endVal="7585"></count-to>
                  </h5>
              ...
              <b-col cols="6" sm="3">
                <div class="p-3 border border-dashed border-start-0">
                  <h5 class="mb-1"> <count-to :duration="5000" :startVal="0" :endVal="367"></count-to>
                  </h5>
