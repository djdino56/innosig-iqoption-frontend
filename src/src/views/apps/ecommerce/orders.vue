              ...
              <b-col sm="auto">
                <div class="d-flex gap-1 flex-wrap">
                  <b-button type="button" variant="primary" class="add-btn" id="create-btn"
                    @click="createModal = !createModal"> <i class="ri-add-line align-bottom me-1"></i> Create
                    Order</b-button>
                  <b-button type="button" variant="soft-success" class="ms-1"> <i
                      class="ri-file-download-line align-bottom me-1"></i> Import </b-button>
                  <b-button variant="soft-danger" class="me-1" id="remove-actions" @click="deleteMultiple"> <i
              ...
              <ul class="nav nav-tabs nav-tabs-custom nav-primary mb-3" role="tablist">
                ...
                <li class="nav-item">
                  <b-link class="nav-link py-3 Pickups" data-bs-toggle="tab" id="Pickups" href="#pickups" role="tab"
                    ...
                    <b-badge variant="secondary" class="align-middle ms-1">2</b-badge>
                  </b-link>
                </li>
                <li class="nav-item">
  ...
  'badge-soft-warning': data.status == 'Pending',
                ...
                <div class="noresult" style="display: none">
                  <div class="text-center">
                    <lottie class="avatar-xl" colors="primary:#25a0e2,secondary:#08a88a" :options="defaultOptions"
                      :height="75" :width="75" />
            ...
            <b-modal v-model="editOrderModal" id="EditModal" hide-footer title="Edit Order" header-class="p-3 bg-light"
              ...
              <b-form action="#" id="editform" class="tablelist-form" autocomplete="off">
                ...
                <div class="hstack gap-2 justify-content-end">
                  ...
                  <b-button type="button" variant="primary" id="add-btn" @click="updateorder">
                    Update
                  </b-button>
                </div>
              </b-form>
