        ...
        <b-row class="g-2">
          ...
          <b-col lg="auto">
            <div class="hstack gap-2">
              <b-button type="button" variant="soft-info">
      ...
      <b-col xl="3" lg="6" v-for="(item, index) of resultQuery" :key="index">
        <b-card no-body class="ribbon-box right overflow-hidden">
          <b-card-body class="text-center p-4">
            ...
            <h5 class="mb-1 mt-4">
              <router-link to="/ecommerce/seller-details" class="link-secondary">{{ item.label }}</router-link>
            </h5>
          ...
          <div class="tab-pane" id="bankDetails" role="tabpanel">
            <b-form action="#">
              <b-row>
                ...
                <b-col lg="12">
                  <div class="hstack gap-2 justify-content-end">
                    <b-button variant="link" class="link-priamry text-decoration-none fw-medium"
                      @click="modalShow = false">
                      <i class="ri-close-line me-1 align-middle"></i> Close
                    </b-button>
                    <b-button type="submit" variant="primary">
