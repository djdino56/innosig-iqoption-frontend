    ...
    { value: 'photoshop', label: 'themesbrand@gmail.com' },
        ...
        <b-modal v-model="removeModal" id="removeItemModal" hide-footer header-class="p-3 bg-light"
            ...
            <div class="mt-2 text-center">
                ...
                <lottie colors="primary:#25a0e2,secondary:#00bd9d" trigger="loop" :options="defaultOptions"
            ...
            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                ...
                <b-button type="button" variant="primary" class="w-sm" id="delete-record">Yes, Delete It!</b-button>
            </div>
        </b-modal>
