                    ...
                    <b-col lg="4" md="6">
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <b-link href="#!" class="float-end fs-14"> View All <i
                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                <h5 class="mb-0 fs-15">
                                    <b-link href="#!" class="link-dark">Crypto Card <b-badge variant="soft-success" class="badge-soft-secondary">743</b-badge>
                                    </b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                        ...
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <b-link href="#!" class="float-end fs-14"> View All <i
                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                <h5 class="mb-0 fs-15">
                                    <b-link href="#!" class="link-dark">Artwork <b-badge variant="soft-success" class="badge-soft-secondary">206</b-badge></b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                    </b-col>
                        ...
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <b-link href="#!" class="float-end fs-14"> View All <i
                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                <h5 class="mb-0 fs-15">
                                    <b-link href="#!" class="link-dark">Music <b-badge variant="soft-success" class="badge-soft-secondary">679</b-badge></b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                    </b-col>
                    ...
                    <b-card-body>
                        ...
                        <div class="explore-place-bid-img overflow-hidden rounded">
                            ...
                            <div class="place-bid-btn">
                                <b-link href="#!" class="btn btn-primary"><i
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <div class="explore-place-bid-img">
                        ...
                        <div class="bg-overlay"></div>
                        <div class="place-bid-btn">
                            <b-link href="#!" class="btn btn-primary"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place
                                Bid</b-link>
                        </div>
                    </div>
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        ...
                        <p class="text-muted mb-0 fs-14">3d Style</p>
                    </b-card-body>
                    <b-card-footer class="border-top border-top-dashed">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 fs-14">
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        ...
                        <p class="text-muted mb-0 fs-14">Crypto Card</p>
                    </b-card-body>
                    <b-card-footer class="border-top border-top-dashed">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 fs-14">
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        ...
                        <p class="text-muted mb-0 fs-14">Video</p>
                    </b-card-body>
                    <b-card-footer class="border-top border-top-dashed">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 fs-14">
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        ...
                        <p class="text-muted mb-0 fs-14">Collectibles</p>
                    </b-card-body>
                    <b-card-footer class="border-top border-top-dashed">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1 fs-14">
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        ...
                        <h5 class="mt-3 mb-1 fs-15">
                            <b-link href="pages-profile.html" class="link-dark">Tonya Noble</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="@/assets/images/nft/img-04.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="mt-3 mb-1 fs-15">
                            <b-link href="pages-profile.html" class="link-dark">Kevin Dawson</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="@/assets/images/nft/img-06.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="mt-3 mb-1 fs-15">
                            <b-link href="pages-profile.html" class="link-dark">Herbert Stokes</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="mt-3 mb-1 fs-15">
                            <b-link href="pages-profile.html" class="link-dark">Thomas Taylor</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="mt-3 mb-1 fs-15">
                            <b-link href="pages-profile.html" class="link-dark">James Price</b-link>
                        </h5>
