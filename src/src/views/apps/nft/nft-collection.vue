            ...
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Artwork <b-badge variant="soft-primary"
                                    class="badge-soft-primary">206</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Crypto Card <b-badge variant="soft-primary"
                                    class="badge-soft-primary">743</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Music <b-badge variant="soft-primary"
                                    class="badge-soft-primary">679</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Games <b-badge variant="soft-primary"
                                    class="badge-soft-primary">341</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Photography <b-badge variant="soft-primary"
                                    class="badge-soft-primary">1452</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">3d Style <b-badge variant="soft-primary"
                                    class="badge-soft-primary">4781</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Collectibles <b-badge variant="soft-primary"
                                    class="badge-soft-primary">3468</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-15">
                            <b-link href="#!" class="link-dark">Videos <b-badge variant="soft-primary"
                                    class="badge-soft-primary">1674</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
