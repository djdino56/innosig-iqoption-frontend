...
<template>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex flex-wrap gap-2">
                  <b-button variant="soft-secondary" class="me-1" id="remove-actions" @click="deleteMultiple">
              ...
              <table class="table align-middle table-nowrap mb-0" id="ticketTable">
                ...
                <tbody class="list form-check-all">
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td>
                      <b-dropdown variant="soft-secondary" toggle-class="text-decoration-none arrow-none" size="sm"
                        no-caret>
                        <template #button-content> <i class="ri-more-fill align-middle"></i> </template>
                        <b-dropdown-item href="/apps/tickets-details"><i
                            class="ri-eye-fill align-bottom me-2 text-muted"></i>View</b-dropdown-item>
                        <b-dropdown-item href="#" class="edit-item-btn" @click="editdata(data)"><i
                            class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</b-dropdown-item>
                        <b-dropdown-item href="#" class="remove-item-btn" @click="deletedata(data)"><i
                            class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</b-dropdown-item>
                      </b-dropdown>
                    </td>
                  </tr>
                </tbody>
  ...
  page + 5
    ...
    <b-modal v-model="modalShow" id="showModal" modal-class="zoomIn" title-class="exampleModalLabel" hide-footer
      header-class="p-3 bg-soft-primary" class="v-modal-custom" centered no-close-on-backdrop size="lg">
      <form id="addform" class="tablelist-form" autocomplete="off">
        ...
        <div class="modal-footer v-modal-footer mt-3">
          <div class="hstack gap-2 justify-content-end">
            ...
            <b-button type="submit" variant="primary" id="add-btn" @click="addorder"> Add Ticket </b-button>
