...
<template>
    <Layout>
        <b-row>
            <b-col lg="12">
                <b-card no-body class="mt-n4 mx-n4 mb-n5  border-0">
                                        ...
                                        <b-col md>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="text-muted">Due Date : <span class="fw-medium">29 Dec,
                                                        2021</span></div>
                                                <div class="vr"></div>
                                                <b-badge pill variant="primary" class="bg-primary fs-12">New</b-badge>
                                                <b-badge pill variant="success" class="fs-12">High</b-badge>
                                            </div>
                                        </b-col>
                                    </b-row>
                                </b-col>
                        ...
                        <form action="javascript:void(0);" class="mt-3">
                            <b-row class="g-3">
                                ...
                                <b-col lg="12" class="text-end">
                                    <b-link href="javascript:void(0);" class="btn btn-primary">Post Comments</b-link>
                                </b-col>
                            </b-row>
                        </form>
                    </b-card-body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="hstack text-wrap gap-1">
                                            <b-badge variant="soft-secondary" class="badge-soft-secondary">Admin</b-badge>
                                            <b-badge variant="soft-secondary" class="badge-soft-secondary">UI</b-badge>
                                            <b-badge variant="soft-secondary" class="badge-soft-secondary">Dashboard</b-badge>
                                            <b-badge variant="soft-secondary" class="badge-soft-secondary">Design</b-badge>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <b-card no-body>
                    ...
                    <b-card-body>
                        <div class="d-flex align-items-center border border-dashed p-2 rounded">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1">
                                    <b-link href="javascript:void(0);" class="link-secondary">Velzon-admin.zip</b-link>
                                </h6>
                        ...
                        <div class="d-flex  align-items-center border border-dashed p-2 rounded mt-2">
                            ...
                            <div class="flex-grow-1 ms-3">
                                <h6 class="mb-1">
                                    <b-link href="javascript:void(0);" class="link-secondary">Velzon-admin.ppt</b-link>
                                </h6>
