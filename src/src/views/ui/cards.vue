                ...
                <b-row>
                    <b-col xxl="4" lg="6">
                        <b-card no-body class="card-body">
                            ...
                            <b-link href="javascript:void(0);" class="btn btn-soft-primary">Apply Now</b-link>
                        </b-card>
                    </b-col>
                    <b-col xxl="4" lg="6">
                        <b-card no-body class="card-body text-center">
                            ...
                            <p class="card-text text-muted">Send a link to apply on mobile device. Appropriately
                                communicate one-to-one technology.</p>
                            <b-link href="javascript:void(0);" class="btn btn-soft-primary">Add New</b-link>
                        </b-card>
                    </b-col>
                    <b-col xxl="4" lg="6">
                ...
                <b-row>
                    <b-col xxl="4" lg="6">
                        <b-card no-body>
                            ...
                            <b-card-footer>
                                <b-link href="javascript:void(0);" class="link-primary float-end">
                                    Read More
                ...
                <b-card no-body>
                    ...
                    <b-card-footer>
                        <div class="hstack gap-2 justify-content-end">
                            <b-link href="javascript:void(0)" class="btn btn-link btn-sm ">
                ...
                <b-row data-masonry="{'percentPosition': true }">
                    ...
                    <b-col sm="6" lg="4">
                        <b-card no-body>
                            ...
                            <b-card-footer>
                                <b-link href="javascript:void(0);" class=" float-end">
                                    Read More
                                    <i class="ri-arrow-right-s-line align-middle ms-1 lh-1"></i>
                                </b-link>
                                <p class="text-muted mb-0">1 days Ago</p>
                    ...
                    <b-col sm="6" lg="4">
                        <b-card no-body class="bg-success text-white text-center p-3">
