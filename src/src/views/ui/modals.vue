                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="hstack gap-2 justify-content-center">
                                                <b-button type="button" variant="light" @click="modalShow1 = false">
                                                    Close</b-button>
                                                <b-link href="javascript:void(0);" class="btn btn-primary">Try Again
                                                </b-link>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="hstack gap-2 justify-content-center">
                                                ...
                                                <b-link href="javascript:void(0);" class="btn btn-primary">
                                                    Completed</b-link>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <b-modal v-model="modalShow30" hide-footer class="v-modal-custom" hide-header-close
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <div class="mt-4 pt-4">
                                            ...
                                            <b-button variant="primary" @click="toggleModal">Continue</b-button>
                                        </div>
                                    </div>
                                </b-modal>
                                    ...
                                    <div class="modal-body text-center">
                                        ...
                                        <div class="mt-4 pt-3">
                                            ...
                                            <p class="text-muted mb-4">Hide this modal and show the first with
                                                ...
                                                email.</p>
                                            <div class="hstack gap-2 justify-content-center">
                                                <b-button variant="soft-primary" @click="toggleModal"> Back to First
                                                </b-button>
