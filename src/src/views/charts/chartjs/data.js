  ...
  data: {
    ...
    datasets: [{
      ...
      },
      {
        ...
        borderDashOffset: 0.0,
        borderJoinStyle: "miter",
        pointBorderColor: "#45CB85",
        pointBackgroundColor: "#fff",
        pointBorderWidth: 1,
        pointHoverRadius: 5,
        pointHoverBackgroundColor: "#45CB85",
...
const bar = {
  ...
  data: {
    ...
    datasets: [{
      ...
      borderColor: getChartColorsArray('["--vz-primary"]'),
      borderWidth: 1,
      hoverBackgroundColor: getChartColorsArray('["--vz-primary"]'),
      hoverBorderColor: getChartColorsArray('["--vz-primary"]'),
