                  ...
                  <b-card no-body>
                    <b-card-body>
                      ...
                      <div class="d-flex flex-wrap gap-2 fs-15">
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">Photoshop</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">illustrator</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">HTML</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">CSS</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">Javascript</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">Php</b-link>
                        <b-link href="javascript:void(0);" class="badge badge-soft-secondary">Python</b-link>
                      </div>
                    </b-card-body>
                  </b-card>
                      ...
                      <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="flex-shrink-0">
                          <b-dropdown variant="link" right toggle-class="arrow-none p-0" no-caret>
                            ...
                            <b-dropdown-item href="#"> View
                            </b-dropdown-item>
                            <b-dropdown-item href="#"> Download
                            </b-dropdown-item>
                                        ...
                                        <b-row class="g-2">
                                          ...
                                          <b-col cols="auto">
                                            <div class="d-flex border border-dashed p-2 rounded position-relative">
                                              ...
                                              <div class="flex-grow-1 ms-2">
                                                <h6><b-link href="javascript:void(0);" class="stretched-link">Bank
                                                    Management
                                                    System -
                                                    PSD</b-link>
                                                </h6>
                        ...
                        <swiper :slides-per-view="3" :space-between="50" :thumbs="{ swiper: thumbsSwiper }">
                          <swiper-slide>
                            <div class="swiper-slide">
                              <b-card no-body class="profile-project-card shadow-none profile-project-primary mb-0">
                              ...
                              <b-card no-body class="profile-project-card shadow-none profile-project-success mb-0">
                                <b-card-body class="p-4">
                                  <div class="d-flex">
                                    <div class="flex-grow-1 text-muted overflow-hidden">
                                      <h5 class="fs-14 text-truncate mb-1">
                                        <b-link href="#" class="text-dark">Client -
                                           John</b-link>
                                      </h5>
                                      <p class="text-muted text-truncate mb-0">
              ...
              <b-card no-body>
                <b-card-body>
                  <b-row>
                    ...
                    <b-col xxl="3" sm="6">
                      <b-card no-body class="profile-project-card shadow-none mb-sm-0 profile-project-secondary">
                        <b-card-body class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                  ...
                  <b-row>
                    <b-col lg="12">
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0)" class="link-secondary">Artboard-documents.zip</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0);" class="link-secondary">Bank Management System</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0);" class="link-secondary">Tour-video.mp4</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0);"  class="link-secondary">Account-statement.xsl</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0);" class="link-secondary">Project Screenshots Collection</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <b-link href="javascript:void(0);"  class="link-secondary">Velzon-logo.png</b-link>
                                    </h6>
                                  </div>
                                </div>
                              </td>
                      ...
                      <div class="text-center mt-3">
                        <b-link href="javascript:void(0);" class="text-primary"><i
